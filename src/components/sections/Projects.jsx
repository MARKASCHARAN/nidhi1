    ...
    setTimeout(() => {
      setProjectsData([
        // Example of updated project data, replace with your actual data
        {
          ...
          image: 'https://www.shutterstock.com/image-vector/web-scraping-information-harvesting-websites-260nw-2088809149.jpg',
          tech: ['Flask', 'BeautifulSoup', 'MongoDB', 'Requests' , 'Pandas', 'Data Cleaning'],
          github: 'https://github.com/tech-nidhi/webscraping',
          demo: 'tech-nidhi.github.io/webscraping/',
        },
        {
